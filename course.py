...
class CourseClass:
    def __init__(self,root):
        ...
        #====Widgets=======
        lb1_courseName=Label(self.root,text="Course Name",font=("goudy old style",15,"bold"),bg="white").place(x=10,y=60)
        lb1_duration=Label(self.root,text="Duration",font=("goudy old style",15,"bold"),bg="white").place(x=10,y=100)

        lb1_charges=Label(self.root,text="Charges",font=("goudy old style",15,"bold"),bg="white").place(x=10,y=140)

        lb1_description=Label(self.root,text="Descripttion",font=("goudy old style",15,"bold"),bg="white").place(x=10,y=180)
        ...
        lb1_search_courseName=Label(self.root,text="  Course Name ",font=("goudy old style",15,"bold"),bg="white").place(x=720,y=60)
