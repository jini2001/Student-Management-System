...
class ReportClass:
    def __init__(self,root):
        ...
        lb1_search=Label(self.root,text="Search By Roll No",font=("goudy old style",20,"bold"),bg="white").place(x=260,y=100) 
        ...
        lb1_marks=Label(self.root,text="Marks",font=("goudy old style",15,"bold"),bg="white",bd=2,relief=GROOVE).place(x=600,y=230,width=150,height=50)
