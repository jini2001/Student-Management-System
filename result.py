...
class ResultClass:
    def __init__(self,root):
       ...
       #=========Image==========
        ...
        lb1_select=Label(self.root,text="Select Student",font=("goudy old style",20,"bold"),bg="white").place(x=50,y=100)
        lb1_name=Label(self.root,text="Name ",font=("goudy old style",20,"bold"),bg="white").place(x=50,y=160)

        lb1_course=Label(self.root,text="Course",font=("goudy old style",20,"bold"),bg="white").place(x=50,y=220)

        lb1_marks=Label(self.root,text="Marks",font=("goudy old style",20,"bold"),bg="white").place(x=50,y=280)
        lb1_full_marks=Label(self.root,text="Full Marks",font=("goudy old style",20,"bold"),bg="white").place(x=50,y=340)
       ...
       #========BUtton=======
        ...
        #==image=======
        self.bg_img=Image.open("image/t1.jpg")
        self.bg_img=self.bg_img.resize((780,400),Image.ANTIALIAS)
    ...
    def add(self):
        ...
        try:
            if self.var_name.get()=="":
                messagebox.showerror("Error","Please first seach student record",parent=self.root)
            else:
